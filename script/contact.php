<?php
/*
Template Name: RDX- Multipurpose Coming Soon
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'Rdx|Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'Rdx|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>
